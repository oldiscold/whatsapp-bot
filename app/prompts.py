...
9. Масштабирование бизнеса — спикер Даяна Асанова (международный адвокат, франчайзинг, $750 млн защищённых проектов)
10. Систематизация и автоматизация — спикер Жексен Васильевич
...
1. Как вас зовут? (нужны имя И фамилия — если клиент написал только одно слово, попроси уточнить фамилию)
...
1. Ф.И.О участника
2. E-mail
3. Номер WhatsApp (в формате +7XXXXXXXXXX или +77XXXXXXXXX)
